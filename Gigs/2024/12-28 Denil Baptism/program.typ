...
#grid(
  columns: 2,
  gutter: 18pt,
  [_1_ The time of grace has come for which we have prayed;\
  Let us devoutly sing songs of joy.\
  \

  _2_ God is made man, while nature wonders;\
  The world is renewed by Christ the King.],

  [_3_ The closed gate of Ezekiel has been passed through;\
  From where the Light has risen; salvation is found.

  _4_ Therefore, let our assembly sing praises now at this time of purification;\
...
#grid(
  columns: 2,
  gutter: 18pt,
  [_1_ What Child is this who, laid to rest\
  ...
  [_2_ Why lies He in such mean estate,\
  Where ox and ass are feeding?\
  Good Christian fear, for sinners here\
  The silent Word is pleasing.

  _3_ So bring Him incense, god, and myrrh,\
...
#grid(
  columns: 3,
  gutter: 18pt,
  [_1_ Sing of Mary, pure and lowly,\
  ...
  [_3_ Glory be to God the Father;\
